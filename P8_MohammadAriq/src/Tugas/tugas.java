    ...
    public static void main(String[] args) {
        ...
        if (opsi != 1) {
            ...
            do {
                ...
                if (persenHadir < 75) {
                    System.out.println("Kehadiran kurang dari 75%, ulangi!");
                }
            ...
            int jumlahTugas = scan.nextInt();

            double totalTugas = 0;

            for (int a = 1; a <= jumlahTugas; a++) {
                System.out.print("Nilai tugas ke-" + a + " : ");
                totalTugas += scan.nextDouble();
            }

            double tugas = totalTugas / jumlahTugas;
